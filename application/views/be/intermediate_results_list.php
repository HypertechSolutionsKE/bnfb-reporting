					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Intermediate Results</span></li>
							</ol>
							...
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">
										...
										<span class="va-middle">Intermediate Results List</span>
										...
										<span class="pull-right"><a href="<?php echo base_url(); ?>be/intermediate_results/add" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Add New Intermediate Result"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add Intermediate Result</a></span>
									</h2>
								</header>							
								<div class="panel-body">
									...
									<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo base_url(); ?>assets/be/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
										...
										<tbody>
											<?php foreach($intermediate_results as $row): ?>
												<tr>
													<td><?php echo $row->intermediate_result_name; ?></td>
													<td><?php echo $row->created_on; ?></td>			
													<td class="center">
														<a href="<?php echo base_url(); ?>be/intermediate_results/edit/<?php echo  $row->intermediate_result_id; ?>" class="on-default edit-row badge btn-success" data-toggle="tooltip" data-placement="top" title="Edit Intermediate Result"><i class="fa fa-pencil"></i></a>
														<a onClick="javascript:return confirm('Do you really wish to delete this Intermediate Result?');" href="<?php echo base_url(); ?>be/intermediate_results/delete/<?php echo  $row->intermediate_result_id; ?>" class="on-default remove-row badge btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Intermediate Result"><i class="fa fa-trash-o"></i></a>												
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
