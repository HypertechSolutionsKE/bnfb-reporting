					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Districts/Provinces</span></li>
							</ol>
							...
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">
										...
										<span class="va-middle">Districts/Provinces List</span>
										...
										<span class="pull-right"><a href="<?php echo base_url(); ?>be/districts/add" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Add New District/Province"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add District/Province</a></span>
									</h2>
								</header>							
										...
										<tbody>
											<?php foreach($districts as $row): ?>
												<tr>
													...
													<td class="center">
														<a href="<?php echo base_url(); ?>be/districts/edit/<?php echo  $row->district_id; ?>" class="on-default edit-row badge btn-success" data-toggle="tooltip" data-placement="top" title="Edit District/Provinces"><i class="fa fa-pencil"></i></a>
														<a onClick="javascript:return confirm('Do you really wish to delete this district?');" href="<?php echo base_url(); ?>be/districts/delete/<?php echo  $row->district_id; ?>" class="on-default remove-row badge btn-danger" data-toggle="tooltip" data-placement="top" title="Delete District/Province"><i class="fa fa-trash-o"></i></a>												
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
