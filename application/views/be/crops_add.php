					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="<?php echo base_url(); ?>be/crops">Crops</a></span></li>
								<?php if (isset($crop)): ?>
									...
									<?php foreach($crop as $row): ?>
										<header class="panel-heading">
											<h2 class="panel-title">
												...
												<span class="va-middle">Edit Crop</span>
												...
												<span class="pull-right"><a href="<?php echo base_url(); ?>be/crops" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Crops list"><i class="fa fa-long-arrow-left"></i></a></span>
											</h2>
										</header>							
										<div class="panel-body">
											<form id="frm_crops_add" action="<?php echo base_url();?>be/crops/update/<?php echo $row->crop_id; ?>" method="post">
												...
												<div class="form-group">
													...
													<input type="text" name="crop_name" id="crop_name" class="form-control" placeholder="Crop Name" value="<?php echo $row->crop_name; ?>" required/>
												</div>
												<div class="form-group">
													<label class="control-label">Description</label>
													<textarea name="crop_description" id="crop_description" rows="4" class="form-control" placeholder="Crop Description"><?php echo $row->crop_description; ?></textarea>
												</div>
								...
								<?php else: ?>
									<header class="panel-heading">
										<h2 class="panel-title">
											...
											<span class="va-middle">Add Crop</span>
											<span class="pull-right"><a href="<?php echo base_url(); ?>be" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Dashboard"><i class="fa fa-home"></i> <span class="hidden-sm"></span></a></span>
											<span class="pull-right"><a href="<?php echo base_url(); ?>be/crops" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Crops list"><i class="fa fa-long-arrow-left"></i></a></span>
										</h2>
									</header>							
									<div class="panel-body">
										<form id="frm_crops_add" action="<?php echo base_url();?>be/crops/save" method="post">
											<?php if (isset($success)): ?>
							 					<div class="alert alert-success block-inner">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							                     	<?php echo $success; ?>
											...
											<div class="form-group">
												<label class="control-label">Name <span class="required">*</span></label>
												<input type="text" name="crop_name" id="crop_name" class="form-control" placeholder="Crop Name" required/>
											</div>
											<div class="form-group">
												<label class="control-label">Description</label>
												<textarea name="crop_description" id="crop_description" rows="4" class="form-control" placeholder="Crop Description"></textarea>
											</div>
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
								...
								<div class="panel-body">
									<div class="sidebar-widget widget-tasks">
										<ul class="list-unstyled m-none">
											...
											<li><a href="<?php echo base_url(); ?>be/crops"><b>Crops</b></a></li>			
