										...
										<tbody>
											<?php foreach($milestones as $row): ?>
												<tr>
													...
													<td class="center">
														<a href="<?php echo base_url(); ?>be/milestones/edit/<?php echo  $row->milestone_id; ?>" class="on-default edit-row badge btn-success" data-toggle="tooltip" data-placement="top" title="Edit Milestone"><i class="fa fa-pencil"></i></a>
