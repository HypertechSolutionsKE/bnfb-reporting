					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Thematic Areas</span></li>
							</ol>
							...
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">
										...
										<span class="va-middle">Thematic Areas List</span>
										...
										<span class="pull-right"><a href="<?php echo base_url(); ?>be/thematic_areas/add" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Add New Thematic Area"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add Thematic Area</a></span>
									</h2>
								</header>							
								<div class="panel-body">
									...
									<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo base_url(); ?>assets/be/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
										...
										<tbody>
											<?php foreach($thematic_areas as $row): ?>
												<tr>
													<td><?php echo $row->thematic_area_name; ?></td>
													<td><?php echo $row->thematic_area_description; ?></td>
													<td><?php echo $row->created_on; ?></td>
													<td class="center">
														<a href="<?php echo base_url(); ?>be/thematic_areas/edit/<?php echo  $row->thematic_area_id; ?>" class="on-default edit-row badge btn-success" data-toggle="tooltip" data-placement="top" title="Edit Thematic Area"><i class="fa fa-pencil"></i></a>
														<a onClick="javascript:return confirm('Do you really wish to delete this Thematic Area?');" href="<?php echo base_url(); ?>be/thematic_areas/delete/<?php echo  $row->thematic_area_id; ?>" class="on-default remove-row badge btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Thematic Area"><i class="fa fa-trash-o"></i></a>												
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
