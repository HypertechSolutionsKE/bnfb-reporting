										...
										<tbody>
											<?php foreach($implementors as $row): ?>
												<tr>
													...
													<td class="center">
														<a href="<?php echo base_url(); ?>be/implementors/edit/<?php echo  $row->implementor_id; ?>" class="on-default edit-row badge btn-success" data-toggle="tooltip" data-placement="top" title="Edit Implementor"><i class="fa fa-pencil"></i></a>
