									...
									<?php foreach($system_user as $row): ?>
										<header class="panel-heading">
											<h2 class="panel-title">
												...
												<span class="pull-right"><a href="<?php echo base_url(); ?>be/system_users" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go back to System Users List"><i class="fa fa-arrow-circle-left"></i> System Users List</a></span>
											</h2>
										</header>							
