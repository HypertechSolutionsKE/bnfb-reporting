					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="<?php echo base_url(); ?>be/thematic_areas">Thematic Areas</a></span></li>
								<?php if (isset($thematic_area)): ?>
									...
									<?php foreach($thematic_area as $row): ?>
										<header class="panel-heading">
											<h2 class="panel-title">
												...
												<span class="pull-right"><a href="<?php echo base_url(); ?>be/thematic_areas" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Thematic Areas list"><i class="fa fa-long-arrow-left"></i></a></span>
											</h2>
										</header>							
										<div class="panel-body">
											<form id="frm_thematic_areas_add" action="<?php echo base_url();?>be/thematic_areas/update/<?php echo $row->thematic_area_id; ?>" method="post">
												...
												<div class="form-group">
													...
													<input type="text" name="thematic_area_name" id="thematic_area_name" class="form-control" placeholder="Thematic Area Name" value="<?php echo $row->thematic_area_name; ?>" required/>
												</div>
												<div class="form-group">
													<label class="control-label">Description</label>
													<textarea name="thematic_area_description" id="thematic_area_description" rows="4" class="form-control" placeholder="Thematic Area Description"><?php echo $row->thematic_area_description; ?></textarea>
												</div>
								...
								<?php else: ?>
									<header class="panel-heading">
										<h2 class="panel-title">
											...
											<span class="va-middle">Add Thematic Area</span>
											<span class="pull-right"><a href="<?php echo base_url(); ?>be" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Dashboard"><i class="fa fa-home"></i> <span class="hidden-sm"></span></a></span>
											<span class="pull-right"><a href="<?php echo base_url(); ?>be/thematic_areas" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Thematic Areas list"><i class="fa fa-long-arrow-left"></i></a></span>
										</h2>
									</header>							
									<div class="panel-body">
										<form id="frm_thematic_areas_add" action="<?php echo base_url();?>be/thematic_areas/save" method="post">
											<?php if (isset($success)): ?>
							 					<div class="alert alert-success block-inner">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							                     	<?php echo $success; ?>
											...
											<div class="form-group">
												<label class="control-label">Name <span class="required">*</span></label>
												<input type="text" name="thematic_area_name" id="thematic_area_name" class="form-control" placeholder="Thematic Area Name" required/>
											</div>
											<div class="form-group">
												<label class="control-label">Description</label>
												<textarea name="thematic_area_description" id="thematic_area_description" rows="4" class="form-control" placeholder="Thematic Area Description"></textarea>
											</div>
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
								...
								<div class="panel-body">
									<div class="sidebar-widget widget-tasks">
										<ul class="list-unstyled m-none">
											...
											<li><a href="<?php echo base_url(); ?>be/thematic_areas"><b>Thematic Areas</b></a></li>
