									...
									<?php foreach($implementor as $row): ?>
										<header class="panel-heading">
											<h2 class="panel-title">
												...
												<span class="pull-right"><a href="<?php echo base_url(); ?>be/implementors" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go back to Implementors List"><i class="fa fa-arrow-circle-left"></i> Implementors List</a></span>
											</h2>
										</header>							
