		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<blockquote class="primary rounded b-thin">
											<p class="text-success">Amount of resources (in $) mobilized in support of biofortification</p>
										</blockquote>				

										<form id="frm_resources_mobilized_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_resources_mobilized();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_resources_mobilized_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_resources_mobilized_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="resources_mobilized_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>