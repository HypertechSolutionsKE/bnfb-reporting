		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<blockquote class="primary rounded b-thin">
											<p class="text-success">Number of national crop programs and extension services (private and public) integrating / prioritizing biofortification and biofortified varieties of staple crops</p>
										</blockquote>				

										<form id="frm_number_national_programs_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_number_national_programs();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_number_national_programs_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_number_national_programs_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="number_national_programs_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>