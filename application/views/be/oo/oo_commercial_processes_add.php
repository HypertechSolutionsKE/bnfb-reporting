		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<blockquote class="primary rounded b-thin">
											<p class="text-success">Number of commercial processors processing biofortified food products</p>
										</blockquote>				

										<form id="frm_commercial_processes_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_commercial_processes();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_commercial_processes_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_commercial_processes_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
												...
												<div class="form-group col-md-3">
													<label class="control-label">No. of commercial processors<span class="required">*</span></label>
													<input type="number" name="no_processes" id="no_processes" class="form-control" value="" required/>
												</div>
												<div class="clearfix"></div>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="commercial_processes_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>