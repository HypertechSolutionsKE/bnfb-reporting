		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<blockquote class="primary rounded b-thin">
											<p class="text-success">Number and type of key issues discussed and prioritized for inclusion in policies through the multisectoral technical and policy platforms</p>
										</blockquote>				

										<form id="frm_key_issues_discussed_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_key_issues_discussed();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_key_issues_discussed_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_key_issues_discussed_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
												...
												<div class="form-group col-md-6">
													...
													<input type="number" name="no_key_issues" id="no_key_issues" class="form-control" value="" required/>
												</div>
												<div class="form-group col-md-6">
													<label class="control-label">Type of Issues</label>
													<textarea name="type_key_issues" id="type_key_issues" rows="4" class="form-control" placeholder="Type of Issues"></textarea>
												</div>												
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="key_issues_discussed_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>