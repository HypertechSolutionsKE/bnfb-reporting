		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<form id="frm_households_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_households();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_households_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_households_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
												...
												<div class="form-group col-md-3">
													<label class="control-label">No. of Households <span class="required">*</span></label>
													<input type="number" name="no_households" id="no_households" class="form-control" value="" required/>
												</div>
												<div class="clearfix"></div>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="households_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>