		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<blockquote class="primary rounded b-thin">
											<p class="text-success">Percentage of national crop program varieties in development that include biofortified traits  </p>
										</blockquote>				

										<form id="frm_percentage_national_programs_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_percentage_national_programs();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_percentage_national_programs_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_percentage_national_programs_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
												...
												<div class="form-group col-md-3">
													...
													<input type="number" name="no_percentage" id="no_percentage" class="form-control" value="" required/>
												</div>
												<div class="clearfix"></div>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="percentage_national_programs_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>