		...
		<script src="<?php echo base_url(); ?>assets/be/javascripts/forms/script.js"></script>
										...
										<blockquote class="primary rounded b-thin">
											<p class="text-success">Number of policy documents and strategic plans that include/prioritize biofortification within the agricultural and nutrition sectors</p>
										</blockquote>				

										<form id="frm_policy_documents_add" action="<?php echo base_url();?>be/outcomes/save" method="post" onsubmit="return save_policy_documents();">
							 					<div class="alert alert-success block-inner" style="display: none;" id="div_policy_documents_success">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							        			</div>               
							 					<div class="alert alert-danger block-inner" style="display: none;" id="div_policy_documents_error"">
							 						<button type="button" class="close" data-dismiss="alert">×</button>	
							        			</div>               
												...
												<div class="form-group col-md-3">
													<label class="control-label">No. of  Documents <span class="required">*</span></label>
													<input type="number" name="no_policy_documents" id="no_policy_documents" class="form-control" value="" required/>
												</div>
												<div class="clearfix"></div>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
														<button class="btn btn-success"><i class="fa fa-save"></i> Submit <i id="policy_documents_spinner" class="fa fa-spinner fa-spin" style="margin-left: 5px; display: none"></i></button>
													</div>
												</div>
											</footer>
										</form>