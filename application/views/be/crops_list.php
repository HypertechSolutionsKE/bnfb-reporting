							...
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">
										...
										<span class="va-middle">Crops List</span>
										...
										<span class="pull-right"><a href="<?php echo base_url(); ?>be/crops/add" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Add New crop"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add Crop</a></span>
									</h2>
								</header>							
										...
										<tbody>
											<?php foreach($crops as $row): ?>
												<tr>
													...
													<td class="center">
														<a href="<?php echo base_url(); ?>be/crops/edit/<?php echo  $row->crop_id; ?>" class="on-default edit-row badge btn-success" data-toggle="tooltip" data-placement="top" title="Edit crop"><i class="fa fa-pencil"></i></a>
														<a onClick="javascript:return confirm('Do you really wish to delete this crop?');" href="<?php echo base_url(); ?>be/crops/delete/<?php echo  $row->crop_id; ?>" class="on-default remove-row badge btn-danger" data-toggle="tooltip" data-placement="top" title="Delete crop"><i class="fa fa-trash-o"></i></a>												
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
