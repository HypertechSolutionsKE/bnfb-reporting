									...
									<header class="clearfix">
										<div class="row">
											...
											<div class="col-sm-12 mt-sm mb-xlg">
												<h4 class="h5 m-none text-dark text-weight-bold text-center">Reporting Period: <span class="text-weight-normal"><?php echo $biweekly_summary_period_from . ' - ' . $biweekly_summary_period_to; ?></span></h4>
											</div>
										</div>
									</header>
									<div class="bill-info">
