				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><a href="<?php echo base_url(); ?>be/intermediate_results">Intermediate Results</a></span></li>
								<?php if (isset($intermediate_result)): ?>
					...
					<div class="row">
						<div class="col-md-6 col-lg-9 col-xl-6">
							<section class="panel">
								<?php if (isset($intermediate_result)): ?>
									<?php foreach($intermediate_result as $row): ?>
										<header class="panel-heading">
											<h2 class="panel-title">
												<span class="text-weight-normal va-middle mr-sm"><i class="fa fa-pencil"></i></span>
												<span class="va-middle">Edit Intermediate Result</span>
												...
												<span class="pull-right"><a href="<?php echo base_url(); ?>be/intermediate_results" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Intermediate Results List"><i class="fa fa-long-arrow-left"></i></a></span>
											</h2>
										</header>							
										<div class="panel-body">
											<form id="frm_intermediate_results_add" action="<?php echo base_url();?>be/intermediate_results/update/<?php echo $row->intermediate_result_id; ?>" method="post">
												...
												<div class="form-group">
													...
													<input type="text" name="intermediate_result_name" id="intermediate_result_name" class="form-control" placeholder="Intermediate Result Name" value="<?php echo $row->intermediate_result_name; ?>" required/>
												</div>
								...
								<?php else: ?>
									<header class="panel-heading">
										<h2 class="panel-title">
											...
											<span class="va-middle">Add Intermediate Result</span>
											<span class="pull-right"><a href="<?php echo base_url(); ?>be" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Dashboard"><i class="fa fa-home"></i> <span class="hidden-sm"></span></a></span>
											<span class="pull-right"><a href="<?php echo base_url(); ?>be/intermediate_results" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Go to Intermediate Results List"><i class="fa fa-long-arrow-left"></i></a></span>
										</h2>
									</header>							
									<div class="panel-body">
										<form id="frm_intermediate_results_add" action="<?php echo base_url();?>be/intermediate_results/save" method="post">
											<?php if (isset($success)): ?>
							 					<div class="alert alert-success block-inner">
							 						<button type="button" class="close" data-dismiss="alert">×</button>
							                     	<?php echo $success; ?>
											...
											<div class="form-group">
												<label class="control-label">Name <span class="required">*</span></label>
												<input type="text" name="intermediate_result_name" id="intermediate_result_name" class="form-control" placeholder="Intermediate Result Name" required/>
											</div>
											<footer class="panel-footer">
												<div class="row">
													<div class="pull-right">
								...
								<div class="panel-body">
									<div class="sidebar-widget widget-tasks">
										<ul class="list-unstyled m-none">
											...
											<li><a href="<?php echo base_url(); ?>be/intermediate_results"><b>Intermediate Results</b></a></li>	
